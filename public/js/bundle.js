...
var showAlert = function showAlert(type, msg) {
  hideAlert();
  var markup = "<div class=\"container alert alert-".concat(type, "\" role=\"alert\">").concat(msg, "</div>");
  var form = document.querySelector('.alertContainer');
  if (form) form.insertAdjacentHTML('beforebegin', markup);else document.querySelector('body').insertAdjacentHTML('afterbegin', markup);
...
exports.sendUserinfo = exports.sendProductinfo = exports.sendEntries = exports.setMarket = exports.logout = exports.login = void 0;
...
var login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(contact, password) {
    var res;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            (0, _alert.showAlert)('danger', 'Error logging out! Try again');
...
var setMarket = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(mkid) {
    var res;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'post',
              url: "http://127.0.0.1:3000/getmarketid/".concat(mkid)
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'send successfully');
            }
          ...
          case 7:
            ...
            (0, _alert.showAlert)('danger', _context3.t0.response.data.message);
...
var sendEntries = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(author, entries, exits, market) {
    var res;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('danger', _context4.t0.response.data.message);
  ...
  return function sendEntries(_x4, _x5, _x6, _x7) {
    return _ref4.apply(this, arguments);
  };
}();

exports.sendEntries = sendEntries;

var sendProductinfo = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(name, price, brandName, summary, description, model, warranty, firstPay, dailyPay, cashPrice, duration) {
    var res;
  ...
  return function sendProductinfo(_x8, _x9, _x10, _x11, _x12, _x13, _x14, _x15, _x16, _x17, _x18) {
    return _ref5.apply(this, arguments);
  };
}();

exports.sendProductinfo = sendProductinfo;

var sendUserinfo = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(name, phoneNumber, address, town, password, passwordConfirm, role) {
    var res;
  ...
  return function sendUserinfo(_x19, _x20, _x21, _x22, _x23, _x24, _x25) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('primary', "".concat(type.toUpperCase(), " updated successfully"));
            }
...
var signUpCustomer = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, phoneNumber, Ncni, town, locationDescription, market, firstPayment, inChargeOf, products, notPercieved, cash) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'added new customer successfully.');
            }
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alert.showAlert)('danger', 'Failure adding new customer.');
  ...
  return function signUpCustomer(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8, _x9, _x10, _x11) {
    return _ref.apply(this, arguments);
  };
}();
...
var userPasswordForm = document.querySelector('.user-data-password');
var customerDataForm = document.querySelector('.customer-data');
var marketForm = document.querySelector('.market-data');
var entryForm = document.querySelector('.entries-data');
var newUserData = document.querySelector('.newuser-data');
var newProductData = document.querySelector('.newproduct-data'); // DELEGATION
...
if (signInForm) {
  signInForm.addEventListener('submit', function (e) {
    ...
    (0, _login.login)(contact, password);
  });
}
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              passwordCurrent = document.getElementById('inputCurrent').value;
              password = document.getElementById('inputNew').value;
              passwordConfirm = document.getElementById('inputConfirm').value;
              _context.next = 7;
...
if (marketForm) {
  marketForm.addEventListener('submit', function (e) {
    e.preventDefault(); // const number = document.getElementById('inputTeamNumber').value;
    // const town = document.getElementById('inputTown').name;

    var market = document.getElementById('inputMarkets').value;
    (0, _login.setMarket)(market);
  });
}
...
if (customerDataForm) {
  ...
  customerDataForm.addEventListener('submit', function (e) {
    ...
    var Ncni = document.getElementById('inputNcni').value;
    var locationDescription = document.getElementById('inputLocation').value;
    var firstPayment = document.getElementById('inputFirstPayment').value;
    var town = document.getElementById('inputTown').name;
    var inChargeOf = document.getElementById('inputInCharge').name;
    var market = document.getElementById('inputMarket').name;
    var listGroup = document.querySelectorAll('li.list-group-item');
    listGroup.forEach(function (el) {
      elValue = el.getAttribute('data-value');
      quan = el.children[1].nextSibling.textContent;
      nonL = el.children[4].nextSibling.textContent;
      cs = el.children[7].nextSibling.textContent; // Fill array with object

      if (quan > 0) products.push({
        refId: "".concat(elValue),
        quantity: quan
      });
      if (nonL > 0) notPercieved.push({
        refId: "".concat(elValue),
        quantity: nonL
      });
      if (cs > 0) cash.push({
    ...
    (0, _signup.signUpCustomer)(name, phoneNumber, Ncni, town, locationDescription, market, firstPayment, inChargeOf, products, notPercieved, cash);
  });
}
...
if (entryForm) {
  ...
  entryForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var auth = document.getElementById('inputAuthor').value;
    var market = document.getElementById('inputMarket').name;
    var entries = [];
    var exits = [];
    var listGroup = document.querySelectorAll('li.list-group-item');
    listGroup.forEach(function (el) {
      var elValue = el.getAttribute('data-value');
      var ent = el.children[1].nextSibling.textContent;
      var ext = el.children[4].nextSibling.textContent;
      if (ent > 0) entries.push({
        refId: elValue,
        quantity: ent
      });
      if (ext > 0) exits.push({
    ...
    (0, _login.sendEntries)(auth, entries, exits, market);
  });
}
...
if (newUserData) {
  newUserData.addEventListener('submit', function (e) {
    ...
    (0, _login.sendUserinfo)(name, phoneNumber, address, town, password, passwordConfirm, role); //clear fields
...
if (newProductData) {
  newProductData.addEventListener('submit', function (e) {
    e.preventDefault();
    var name = document.getElementById('inputPdtName').value;
    var price = document.getElementById('inputPrice').value;
    var brandName = document.getElementById('inputBrandName').value;
    var summary = document.getElementById('inputSummary').value;
    var description = document.getElementById('inputDescription').value;
    var model = document.getElementById('inputModel').value.toUpperCase();
    var warranty = document.getElementById('inputWarranty').value;
    var firstPay = document.getElementById('inputFirstPay').value;
    var dailyPay = document.getElementById('inputDailyPay').value;
    var cashPrice = document.getElementById('inputCashPrice').value;
    var duration = document.getElementById('inputDuration').value;
    (0, _login.sendProductinfo)(name, price, brandName, summary, description, model, warranty, firstPay, dailyPay, cashPrice, duration); //clear fields
...
function customSelectField() {
  var spanGroup = document.querySelectorAll('span');
  spanGroup.forEach(function (el) {
    var text;
    var result;
